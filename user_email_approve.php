...
<div class="jumbotron text-center">
    ...
    <p class="lead"><strong>Approval request is sent to user for Logged In  DR grading system</strong></p>
    <hr>
  </div>
<head>
...
<body>
	<center>
		...
		$sql = "UPDATE `signIn` SET `signIn_check` = '1' WHERE `email` ='$email';";
		...
		if(mysqli_query($conn, $sql)){
			...
			// 	. "$pass\n");
			$to=$email;
			$subject ="Request Approve for DR Grading System";
			$message = " your request is approve please login to DR grading system.";
